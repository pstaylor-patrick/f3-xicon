...
export const regions: Region[] = [
  ...
  { slug: 'austin', name: 'Austin', city: 'Liberty Hill', state: 'TX' },
  {
    slug: 'north-houston-noho',
    name: 'North Houston (NoHo)',
    city: 'Houston',
    state: 'TX',
  },
  { slug: 'muletown', name: 'Muletown', city: 'Columbia', state: 'TN' },
  { slug: 'expedition', name: 'Expedition', city: 'Festus', state: 'MO' },
  {
    slug: 'hampton-roads',
    name: 'Hampton Roads',
    city: 'Bayville Farms Park',
    state: 'CT',
  },
  { slug: 'the-fe', name: 'The Fe', city: 'Olathe', state: 'KS' },
  { slug: 'pineywoods', name: 'Pineywoods', city: 'Longview', state: 'TX' },
  {
    slug: 'lake-charles',
    name: 'Lake Charles',
    city: 'Lake Charles',
